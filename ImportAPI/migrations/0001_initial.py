# Generated by Django 3.2 on 2021-08-03 05:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentcode', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdate', models.DateTimeField(default=datetime.datetime.now, verbose_name='Дата начала действия записи')),
                ('enddate', models.DateTimeField(blank=True, null=True, verbose_name='Дата окончания действия записи')),
                ('budget', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ImportAPI.budget', verbose_name='Бюджет')),
            ],
            options={
