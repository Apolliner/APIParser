# Generated by Django 3.2 on 2021-08-05 23:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budgettype', models.CharField(choices=[(None, '(Unknown)'), ('00', 'Прочие бюджеты'), ('01', 'Федеральный бюджет'), ('02', 'Бюджет субъекта РФ'), ('03', 'Бюджеты внутригородских МО г. Москвы и г. Санкт-Петербурга'), ('04', 'Бюджет городского округа'), ('05', 'Бюджет муниципального района'), ('06', 'Бюджет Пенсионного фонда РФ'), ('07', 'Бюджет ФСС РФ'), ('08', 'Бюджет ФФОМС'), ('09', 'Бюджет ТФОМС'), ('10', 'Бюджет поселения'), ('11', ',Без описания 11'), ('12', ',Без описания 12'), ('13', ',Без описания 13'), ('14', ',Без описания 14'), ('15', ',Без описания 15'), ('98', 'Распределяемый доход'), ('99', 'Доход организации (только для ПДИ)')], default='00', max_length=2, verbose_name='Тип бюджета')),
                ('loaddate', models.DateTimeField(default=datetime.datetime.now, verbose_name='Дата загрузки записи')),
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ImportAPI.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
